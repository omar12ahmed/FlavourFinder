...
function ContactPage() {
	...
	const handleSubmit = (e) => {
		...
		if (!formData.name) {
			setError(`Please fill in name field before submitting the form.`);
		} else if (!formData.email) {
			setError(`Please fill in the email field before submitting the form.`);

		} else if (!formData.reasons) {
			setError(`Please fill in reason for contact field before submitting the form.`);

		} else if (!formData.description) {
			setError(`Please fill in description field before submitting the form.`);
